...
//!
//! DICOM RLE has no trailing end-of-stream marker, so the "chop the trailing
//! marker" case (c) does not apply and is intentionally omitted.

use jpegrle::error::CodecError;
use jpegrle::{decode, encode};
